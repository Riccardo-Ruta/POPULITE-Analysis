...
LWIC_ITA <- dictionary(file = "data/large_files/Italian_LIWC2007_Dictionary.dic", 
                       format = "LIWC")
emotions <- c("Emo_Pos", "Emo_Neg", "Ansia", "Rabbia", "Tristez", "Ottimis" )
...
##################
```
### Are the average values of [...] for each party statistically different from each other?
